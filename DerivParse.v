...
Section RegLang.
  ...
  #[export] Instance re_equiv_refl : Reflexive re_equiv.
  Proof. now red; unfold re_equiv. Qed.

  #[export] Instance re_equiv_sym : Symmetric re_equiv.
  Proof. now red; unfold re_equiv. Qed.

  #[export] Instance re_equiv_trans : Transitive re_equiv.
  Proof. red; unfold re_equiv; intros; etransitivity; auto. Qed.

  #[export] Instance re_equiv_equiv : Equivalence re_equiv.
...
#[export] Instance RLang_KleeneAlgebra `{EqDec} : KleeneAlgebra ∅ ϵ Alt Concat re_equiv.
Proof.
  constructor; intros; [
    apply alt_empty_l |
    apply alt_commute |
